# Flask app for Ebuss recommendations
...
@app.route('/')
def home():
    """Main page with sample users for easy testing"""
...
def recommend():
    ...
    try:
        ...
        # Format for frontend - convert to percentages
        formatted = []
        ...
        return jsonify({'success': False, 'error': 'Error generating recommendations.'})
